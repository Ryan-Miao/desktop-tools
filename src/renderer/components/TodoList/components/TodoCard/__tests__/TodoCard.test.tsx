...
describe('TodoCard Component', () => {
  ...
  it('should show completed state when todo is completed', () => {
    ...
    render(<TodoCard todo={completedTodo} onClick={() => {}} isSelected={false} />);
  ...
  it('should call onClick when card is clicked', () => {
    ...
    render(<TodoCard todo={mockTodo} onClick={handleClick} isSelected={false} />);
  ...
  it('should display subtasks count', () => {
    ...
    render(<TodoCard todo={todoWithSubtasks} onClick={() => {}} isSelected={false} />);
