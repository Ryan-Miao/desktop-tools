...
type Mode = 'format' | 'minify' | 'validate' | 'escape' | 'unescape' | 'csvToJson' | 'jsonToCsv';
...
const PluginWindow: React.FC<{
  ...
  onMaximize?: () => void;
  isMaximized?: boolean;
}> = ({ title, icon, children, onClose, onMinimize, onMaximize, isMaximized }) => {
  return (
    <div style={{
      width: '100%',
      height: '100%',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: '1px solid rgba(255, 255, 255, 0.1)',
              background: mode === 'format' ? 'rgba(59, 130, 246, 0.3)' : 'rgba(255, 255, 255, 0.05)',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: '1px solid rgba(255, 255, 255, 0.1)',
              background: mode === 'minify' ? 'rgba(59, 130, 246, 0.3)' : 'rgba(255, 255, 255, 0.05)',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: '1px solid rgba(255, 255, 255, 0.1)',
              background: mode === 'validate' ? 'rgba(59, 130, 246, 0.3)' : 'rgba(255, 255, 255, 0.05)',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: '1px solid rgba(255, 255, 255, 0.1)',
              background: mode === 'escape' ? 'rgba(59, 130, 246, 0.3)' : 'rgba(255, 255, 255, 0.05)',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: '1px solid rgba(255, 255, 255, 0.1)',
              background: mode === 'unescape' ? 'rgba(59, 130, 246, 0.3)' : 'rgba(255, 255, 255, 0.05)',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: '1px solid rgba(255, 255, 255, 0.1)',
              background: mode === 'csvToJson' ? 'rgba(59, 130, 246, 0.3)' : 'rgba(255, 255, 255, 0.05)',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: '1px solid rgba(255, 255, 255, 0.1)',
              background: mode === 'jsonToCsv' ? 'rgba(59, 130, 246, 0.3)' : 'rgba(255, 255, 255, 0.05)',
        ...
        <div style={{ flex: 1, display: 'flex', gap: '16px', minHeight: 0 }}>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
            <div style={{
              ...
              <span style={{ color: '#a0a0a0', fontSize: '12px', fontWeight: '500' }}>
                {getInputLabel()}
              </span>
              <button
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
            <div style={{
              ...
              <span style={{ color: '#a0a0a0', fontSize: '12px', fontWeight: '500' }}>输出</span>
              <button
                onClick={handleCopy}
                ...
                style={{
                  ...
                  borderRadius: '6px',
                  border: '1px solid rgba(255, 255, 255, 0.1)',
                  background: !output || mode === 'validate' ? 'rgba(255, 255, 255, 0.02)' : 'rgba(255, 255, 255, 0.05)',
                  color: !output || mode === 'validate' ? '#505050' : '#b0b0b0',
                  cursor: !output || mode === 'validate' ? 'not-allowed' : 'pointer',
                  fontSize: '11px'
                }}
              >
                复制
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <span style={{ color: '#b0b0b0', fontSize: '16px', fontWeight: '600' }}>
