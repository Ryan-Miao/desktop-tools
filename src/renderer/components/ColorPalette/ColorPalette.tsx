  ...
  const generatePalette = useCallback(() => {
    ...
    switch (scheme) {
      case "complementary":
        ...
        newPalette = [
          baseColor,
          createColor(rgbToHex(hslToRgb((h + 180) % 360, s, l))),
        ];
        break;
      ...
      case "analogous":
        // 3 adjacent colors
        newPalette = [
          createColor(rgbToHex(hslToRgb((h - 30 + 360) % 360, s, l))),
          baseColor,
          createColor(rgbToHex(hslToRgb((h + 30) % 360, s, l))),
        ];
        break;
      ...
      case "triadic":
        ...
        newPalette = [
          baseColor,
          createColor(rgbToHex(hslToRgb((h + 120) % 360, s, l))),
          createColor(rgbToHex(hslToRgb((h + 240) % 360, s, l))),
        ];
        break;
      ...
      case "split-complementary":
        ...
        newPalette = [
          baseColor,
          createColor(rgbToHex(hslToRgb((h + 150) % 360, s, l))),
          createColor(rgbToHex(hslToRgb((h + 210) % 360, s, l))),
        ];
        break;
      ...
      case "tetradic":
        ...
        newPalette = [
          baseColor,
          createColor(rgbToHex(hslToRgb((h + 90) % 360, s, l))),
          createColor(rgbToHex(hslToRgb((h + 180) % 360, s, l))),
          createColor(rgbToHex(hslToRgb((h + 270) % 360, s, l))),
        ];
        break;
      ...
      case "monochromatic":
        ...
        newPalette = [
          createColor(rgbToHex(hslToRgb(h, s, Math.max(20, l - 30)))),
          createColor(rgbToHex(hslToRgb(h, s, Math.max(30, l - 15)))),
          baseColor,
          createColor(rgbToHex(hslToRgb(h, s, Math.min(70, l + 15)))),
          createColor(rgbToHex(hslToRgb(h, s, Math.min(80, l + 30)))),
        ];
        break;
